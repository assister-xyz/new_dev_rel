  ...
  return (
    <Box className='flex justify-center items-center min-h-[600px] '>
      <Alert className='w-[90%] md:w-[320px]'>
        ...
        <AlertDescription>
          Mail:{" "}
          <a href='mailto:Dima.Dimenko@assisterr.xyz' className='font-semibold hover:text-[#FF6B00]'>
            Dima.Dimenko@assisterr.xyz
          </a>
          <br />
          Telegram:{" "}
          <a href='https://t.me/Dimenko' className='font-semibold hover:text-[#FF6B00]'>
            @Dimenko
          </a>
        </AlertDescription>
      </Alert>
